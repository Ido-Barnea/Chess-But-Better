...
export const INVENTORIES_CONTAINER_ELEMENT_ID = 'inventories-container';
export const OVERWORLD_BOARD_BUTTON_ELEMENT_ID = 'board-overworld-button';
export const HELL_BOARD_BUTTON_ELEMENT_ID = 'board-hell-button';
export const HEAVEN_BOARD_BUTTON_ELEMENT_ID = 'board-heaven-button';
